...
export default function Message() {
    return (
        ...
        <div style={{ textAlign: 'right'}}>November 15<sup>th</sup>, 2021</div>
            ...
            Long story short, it seems like one of the original admins <a href="https://www.reddit.com/r/columbia/comments/qt6v19/official_culpa_relaunch_at_wwwculpaapp" rel="noreferrer" target="_blank">ares rebooting CULPA</a>, which is great news.
